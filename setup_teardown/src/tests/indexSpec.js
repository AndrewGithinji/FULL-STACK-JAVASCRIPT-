...
describe('Tests for all array utilities', function () {
    var numArr = [3, 4, 5, 6];
    var wordArr = ['cat', 'dog', 'rabbit', 'bird'];
    describe('Test for new array', function () {
        ...
        describe('Test for a capitalized string', function () {
        ...
        describe('Calculates the sum of numbers', function () {
        ...
        describe('Checks for numbers in array', function () {
        ...
        describe('Concatinates numbers in an array', function () {
        ...
        describe('Checks the items in the array', function () {
        ...
        describe('Tests for the largest number', function () {
